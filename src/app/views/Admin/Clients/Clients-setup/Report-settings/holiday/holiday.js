...
class HolidayEC extends Component {
  state = {
    loading: true,
    rg: [],
    ot: [],
                      ...
                      this.props.earningsCodes.map((ec, i) => (
                        <div key={`ec_${i}`} className="df acsa ec_line">
                          ...
                          <div className="swp_sec">
                            <Checkbox
                              key={`hol_rg_${i}`}
                              checked={this.state.holidayRG[i].checked}
                              id={`hol_rg_${i}`}
                          ...
                          <div className="bp_sec">
                            <Checkbox
                              key={`hol_ot_${i}`}
                              checked={this.state.holidayOT[i].checked}
                              id={`hol_ot_${i}`}
                              clickAction={this.clickAction}
                              value={i}
                              field="hol_ot"
