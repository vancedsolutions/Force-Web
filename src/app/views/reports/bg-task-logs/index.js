...
export class BgTaskLogsView extends Component {
    state = {
        loading: false,
        rowData: [],
    };
    ...
    getBgTaskLogs = async (params) => {
        let logs = await axios.get('api/logs/bg-tasks', { params }).catch(e => e);
        return logs?.data || [];
    };

    columnDefs = [
        {
            headerName: "Task", field: "taskName", sortable: true, filter: false, flex: 1, resizable: true, width: 180
        },
        { headerName: "Import Id", field: "importId", sortable: true, filter: false, flex: 1, resizable: true, width: 120 },
        { headerName: "Company Short Name", field: "client", sortable: true, filter: false, flex: 1, resizable: true, width: 150 },
        { headerName: "Action", field: "actionDescription", sortable: true, filter: false, flex: 1, resizable: true, width: 100 },
        {
            headerName: "Status", field: "status", sortable: true, filter: false, resizable: true, flex: 1, width: 100
        },
        { headerName: "Created At", field: "createdAt", sortable: true, filter: false, resizable: true, flex: 1, width: 180 },
    ...
    onGridReady = async (params) => {
        ...
        let dataSource = {
            getRows: async (params) => {
                ...
                let logsReport = await this.getBgTaskLogs({
